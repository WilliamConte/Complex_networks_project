...
def extract_data_pipeline_from_lines(file_pattern_topologies, single_filename_lines, filename_nodes, output_edges, output_nodes,
                          city_path = "./Berlin", file_prefix = "berlin-", file_suffix = ".txt", line_prefixes=None, more_files=False, separator = True):
    #edges

    df_edges, dict_key = edges_from_lines(file_pattern_topologies, filename_nodes)
